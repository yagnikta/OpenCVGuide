...
cv2.RETR_LIST	All contours, but no hierarchy (just a.jpg flat list)
...
# Draw contours on a.jpg copy of the original
output = image.copy()
...
# Calculates the perimeter of the outer contour. It is also called arc length. It can be found out using cv2.arcLength() function. Second argument specify whether shape is a.jpg closed contour (if passed True), or just a.jpg curve.
